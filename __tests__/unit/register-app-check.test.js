...
describe("register-app-check", () => {
  ...
  describe("getAndroidAppId()", () => {
    ...
    test("throws error when no apps found", async () => {
      ...
      await expect(
        getAndroidAppId("test-project", "com.example.app"),
      ).rejects.toThrow("No Android apps found");
    });
    ...
    test("throws error when package not found", async () => {
      ...
      await expect(
        getAndroidAppId("test-project", "com.example.app"),
      ).rejects.toThrow("Android app with package com.example.app not found");
    });
    ...
    test("handles Firebase CLI error", async () => {
      ...
      await expect(
        getAndroidAppId("test-project", "com.example.app"),
      ).rejects.toThrow("Failed to get Android app ID");
    });
  });
